 ...
 * @author TRUNG DUC
 */
public class HienTtCtsp extends javax.swing.JDialog {

    /**
     * Creates new form HienTtCtsp
     */
    public  HienTtCtsp(java.awt.Frame parent, boolean modal,Qlsp qlsp) {
        super(parent, modal);
        initComponents();
        txtMaSp.setText("ok");
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Chắc chắn mua");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HienTtCtsp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HienTtCtsp dialog = new HienTtCtsp(new javax.swing.JFrame(), true,new Qlsp());
